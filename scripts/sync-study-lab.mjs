...
const entries = ['index.html', 'style.css', 'lessons.js', 'app.js', 'engr-data.js', 'engr213.js', 'engr213.css', 'teaching.js', 'teaching-ui.js', 'teaching.css', 'hub.css', 'assets', 'vendor', 'prompts']
